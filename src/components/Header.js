...
const Header = () => {
  let [sidebarVisible, setSidebarVisibility] = useState(false);
  const toggleSidebar = () => {
    ...
    <header>
      ...
      >
        <svg viewBox="0 0 16 16">
          <rect x="1" y="3" fill="#333333" width="14" height="2" />
          <rect x="1" y="7" fill="#333333" width="14" height="2" />
          <rect x="1" y="11" fill="#333333" width="14" height="2" />
        </svg>
